import { edgeKey, nearestNodeIdFromLatLng } from '../graph/roadGraph'
...
export function buildMovementPlan({ graph, routeNodes, trafficState, corridorEdgesSet }) {
  ...
  for (let i = 0; i < routeNodes.length - 1; i++) {
    ...
    const durationSeconds = edgeCostSeconds({ graph, trafficState, corridorEdgesSet: corridor, ek })
...
export function getPositionAtTime({ movementPlan, tSeconds }) {
